...
- Validar formato básico de entrada (campo vazio, tipo incorreto)
- Expor os dados preenchidos via `get_data()`
...
A coordenação entre form e serviço é responsabilidade da `MainWindow`.
